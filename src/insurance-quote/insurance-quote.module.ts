...
@Module({
  imports: [TypeOrmModule.forFeature([InsuranceQuote, InsuranceProposal, Client, Producer])],
  controllers: [InsuranceQuoteController, UploadProposalController],
  providers: [InsuranceQuoteService, InsuranceProposalService, GoogleVisionService],
})
